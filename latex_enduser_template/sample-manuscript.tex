...
\hline
P11 & A (Enhanced $\to$ Original) & 735 seconds & 364 seconds & 371 seconds \\
\hline
P13 & A (Enhanced $\to$ Original) & 610 seconds & 407 seconds & 203 seconds \\
\hline
P15 & A (Enhanced $\to$ Original) & 410 seconds & 540 seconds & -140 seconds \\
\hline
P17 & A (Enhanced $\to$ Original) & 560 seconds & 440 seconds & 120 seconds \\
\hline
...
\hline
P12 & B (Original $\to$ Enhanced) & 450 seconds & 720 seconds & -270 seconds \\
\hline
P14 & B (Original $\to$ Enhanced) & 540 seconds & 670 seconds & -130 seconds \\
\hline
P16 & B (Original $\to$ Enhanced) & 335 seconds & 400 seconds & -65 seconds \\
\hline
P18 & B (Original $\to$ Enhanced) & 540 seconds & 862 seconds & -322 seconds \\
\hline
\end{tabular}
...
To answer the second research question regarding the perceived usability of the system, 
...
barrier comes before and is more important than other barriers. The low NASA-TLX workload scores (mean: 1.88) and high SUS 
scores (mean: 84.1) indicate that once the selection barrier is removed, once users no longer need to find and choose features, 
...
\begin{itemize}
    \item \textbf{SUS limitation:} SUS measures perceived usability rather than objective usability metrics, such as error rates or task success beyond completion time.
