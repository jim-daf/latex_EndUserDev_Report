...
The Reuse Assistant imposes a remarkably low workload on users, with an overall mean score of \textbf{20.00} on a scale of 
100. This indicates that the feature is highly usable and demands very little effort
...
As shown in the figure \ref{fig:nasa_tlx_dist}, the six NASA-TLX dimensions assessed were:
