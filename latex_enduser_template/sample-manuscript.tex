...
The study was conducted in a controlled setting with researcher guidance available, 
tasks completed in a single session, and 
...
\textit{Mitigation:} We included chemistry domain experts as participants rather than 
generic users, and the task was based on actual 
laboratory procedures. However, long-term field studies observing the Reuse Assistant 
in authentic work contexts are necessary to 
...
all participants successfully created them with the help of the Reuse Assistant. The feature received high usability ratings (SUS mean: 84.1) and low 
...
domain experts should actively guide users rather than waiting for them to discover 
features independently.

\subsection{Future Work}

Future research should test the Reuse Assistant in real laboratory settings over extended 
periods to determine whether users learn to recognize reuse opportunities independently. 
Studies with more participants from diverse backgrounds would help identify which user 
groups benefit most from automated guidance. The feature should also be evaluated with more 
complex programming tasks and tested in other end-user programming environments beyond 
OpenRoberta.
