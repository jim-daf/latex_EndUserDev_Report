...
\begin{itemize}
    \item RQ1: How effective is the enhanced OpenRoberta at promoting use of reusable custom blocks?
    \item RQ2: How effective are the visual highlights at guiding the user towards creating reusable custom blocks?
    \item RQ3: How the enhanced OpenRoberta compare to the standard OpenRoberta, in terms of:
    \begin{enumerate}
