...
Robots can be used in chemistry labs to automate experiments with great effect, as many experiments involve steps that are repetitive, and suspectible to human error - such as a step being overlooked, instructions being misread, etc.
Using robots in labs also comes with the added bonus of chemists not having to handle dangerous chemicals. 

One critical challenge in EUD is code reuse. Users frequently create repetitive code because they struggle to recognize duplicate patterns, lack knowledge about abstraction mechanisms, or find existing tools too complex to use effectively. This problem manifests in several ways: programs become unnecessarily long and difficult to maintain and small changes require modifications in multiple locations, increasing the risk of errors. Several  visual programming environments, like OpenRoberta Lab, don't provide assistance in identifying when code should be reused or how to extract repeated sequences into reusable components. As lab work in chemistry involves many repetitive tasks, these challenges can easily become an obstacle for the chemists, which in turn may turn them away from using cobots, as the inconvenience outweighs the benefits.
%and users miss opportunities to learn fundamental programming concepts such as modularity and abstraction.
...
the effectiveness of the proposed features for guiding users in creating reusable custom blocks within the OpenRoberta environment. Participants will be recruited from local educational institutions, specifically chemistry students and teachers who frequently engage 
in laboratory work. A sufficient number of (x) participants will be selected to ensure a diverse 
...
The procedure will begin with a survey to evaluate participants’ prior understanding of 
modular programming concepts, followed by two tasks containing several repetitative steps, to make the user focus on reuse. 
...
The second task is more focused on the domain of chemistry, as it is modelled after the instructions to a real lab experiment perfomed by chemistry students. The experiment instructions were obtained from one of the participants, and can be found in appendix XXX.
...
The participants will be chemistry students and one supervisor from the University of Southern Denmark (SDU). One of the authors of this paper knows a student from the chemistry line, who was recruited and also assisted in recruiting others from his class. 

The participants will be asked to fill out a survery before starting the tasks, in order to asses their background, as well as their knowledge about block-based programming, the use of cobots, OpenRoberta Lab and their experience with programming. 
