...
including overall comparisons, within-group improvements, and the calculated order effect.
...
Participants in Group A were slower by an average of 174.9 seconds when they stopped using the feature. This shows that the gain from adding the assistant was greater than the loss from removing it.
