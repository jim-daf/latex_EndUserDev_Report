...
applies similar principles within the OpenRoberta GO environment by automating the detection of duplicate 
...
Adler et al. (2021) introduced a search-based refactoring approach to improve the readability of Scratch
 ...
 applies similar principles in the OpenRoberta GO environment, focusing on detecting duplicate code 
