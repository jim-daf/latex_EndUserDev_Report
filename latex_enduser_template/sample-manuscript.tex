...
% UNCOMMENT THE LINES BELOW TO ADD A SCREENSHOT OF YOUR BLOCKS
 \begin{figure}[h]
     \centering
...
\begin{enumerate}
    \item \textbf{Task Completion Time:} Comparing the participants who first used the enhanced version of OpenRoberta against those who first used the standard version.
