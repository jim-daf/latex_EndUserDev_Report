...
We developed the Reuse Assistant, a tool that automatically detects duplicate code sequences and guides users to create reusable custom blocks in the OpenRoberta environment.
...
all participants successfully created reusable blocks when help from the Reuse Assistant was available. The feature received high usability ratings (SUS mean: 84.03) and low workload scores (NASA-TLX mean: 1.92), demonstrating that automated guidance can be both effective and easy to use.
