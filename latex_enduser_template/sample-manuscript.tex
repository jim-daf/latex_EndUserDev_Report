...
\title{Guiding End-Users Toward Code Reuse: An Evaluation of Automated Assistance in Block-Based Programming for Chemistry Laboratory Automation}
...
\noindent\textbf{Objective: This study investigates whether automated guidance can help end-users recognize and apply code reuse practices. We developed the Reuse Assistant, a tool that automatically detects duplicate code sequences in OpenRoberta and guides users to create reusable custom blocks through visual highlighting and one-click refactoring.}

\noindent\textbf{Methods: Through a crossover study with 10 participants from the chemistry domain, we evaluated the tool's impact on performance, usability, and perceived workload.}

\noindent\textbf{Results: Automated guidance increased reuse adoption from 0\% in the standard environment to 100\% with the Reuse Assistant. The tool achieved high usability scores (SUS mean: 84.1) and imposed minimal cognitive burden (NASA-TLX mean: 1.88). A significant order effect revealed that prior manual experience helps users appreciate automation benefits.}
...
the risk of errors and discouraging adoption of automation tools.
...
We developed the Reuse Assistant, a tool that automatically detects duplicate code sequences and guides users to create reusable custom 
blocks through visual highlighting and one-click refactoring. Through a crossover study with 10 participants from the chemistry domain, 
