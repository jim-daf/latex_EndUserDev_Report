...
To satisfy the requirements above, we designed the Reuse Assistant (source code available at: \url{https://github.com/jim-daf/end_user_deploy}, and related blockly source code: \url{https://github.com/VictoriousAnnro/blockly_openRoberta}) as a feature for the Open Roberta Lab. 
...
Tables \ref{tab:group_a_times} and \ref{tab:group_b_times} present the individual completion times for all participants using either version of Open Roberta.
...
Secondly, the scores show a strong consistency between users.
...
The significant carryover effect (t = 6.02, p < 0.001) reveals a counter-intuitive finding: participants who received automated 
assistance first showed smaller performance improvements than those who completed the task manually first.
This 367-second performance gap suggests that automation effectiveness depends on users having established mental models of the problem space.
